...
for (i in 1:nrow(nd_grid)) {
  ...
  # Data output
  out_dir_12 <- paste0(data_dir, "tcd_2012_tiles/")
  raster_out(tcd12_tile, out_dir_12, "tcd_2012_", i)
  out_dir_18 <- paste0(data_dir, "tcd_2018_tiles/")
...
tcd12_list <- list.files(paste0(data_dir, "tcd_2012_tiles/"), 
                         full.names = TRUE, pattern = ".tif$")
tcd18_list <- list.files(paste0(data_dir, "tcd_2018_tiles/"), 
                         full.names = TRUE, pattern = ".tif$")
